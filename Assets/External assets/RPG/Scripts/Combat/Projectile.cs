...
namespace RPG.Combat
{
    public class Projectile : MonoBehaviour
    {
        ...
        private void Awake()
        {
            SoundManager.Instannce.PlaySound(Sound.Arrowprojectilelaunch, transform.position);
        }
        private void Start() 
        {
        ...
        private void OnTriggerEnter(Collider other)
        {
            ...
            OnImpact?.Invoke();
            SoundManager.Instannce.PlaySound(Sound.ArrowprojectileImpact, transform.position);
            if (hitEffect != null)
            {
